                    ...
                    <div>
                        <div className = "bg-white border border-gray-200 rounded-xl p-8 sticky top-8">
                            ...
                            <div className = "space-y-5">
                                ...
                                <div>
                                    <Label className = "block text-sm text-gray-700 mb-2">
                                        Business Addresss <span className = "text-red-500">*</span>
                                    </Label>
                                    <Input 
                                        type = "text"
                                ...
                                <div>
                                    ...
                                    {!formData.drivingLicense ? (
                                        <Label className = {`flex flex-col items-center justify-center w-full h-32 border-2 border-dashed rounded-lg cursor-pointer hover:bg-gray-50 transition ${
                                            ...
                                            <p className = "text-xs text-gray-400 mt-1">Maximum file size: 5MB (jpg, png)</p>
                                            <Input 
                                                type = "file"
                                                accept = "image/*"
                                ...
                                <div>
                                    ...
                                    {!formData.businessLicense ? (
                                        <Label className = {`flex flex-col items-center justify-center w-full h-32 border-2 border-dashed rounded-lg cursor-pointer hover:bg-gray-50 transition ${
                                            ...
                                            <p className = "text-xs text-gray-400">Maximum file size: 5MB (jpg, png)</p>
                                            <Input 
                                                type = "file"
                                                accept = "image/*"
