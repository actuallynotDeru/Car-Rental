...
import { getAllCars, getCarById, createCar, updateCar, deleteCar, getCarsByOwnerId, rateCar } from "../controllers/carController.js";
...
router.post("/:id/rate", rateCar); // Rate a car
